...
import { clampValue, invPower2, power2 } from "@core/ax/number_utils";
import { createMultiInterpolator } from "@core/ax-audio/basic/multi_interpolator";
import { applySoftClipAt } from "@core/ax-audio/effects/soft_clip_shaper";
import { createFilterOnePoleHighPass } from "@core/ax-audio/filters/filter_onepole_highpass";
