import { mapUnaryBipolar, power2 } from "@core/ax/number_utils";
import { MoId, MoType, MotionParams } from "@core/base/parameter_defs";
import { Bus } from "@core/base/synthesis_bus";
import { mixMotionPartValues } from "@core/motions/funcs/motion_mux";
import { mapParamOscPitchToRelativeNote } from "@core/motions/funcs/pitch_mapping";
import { MotionPartValues } from "@core/motions/impl/motion_common";
import { processMotionWrapper } from "@core/motions/impl/motion_wrapper";
