import { fracPart } from "@core/ax/number_utils";
import {
  GaterType,
  GateStride,
  MotionStride,
...
import { getStepPeriod } from "@core/motions/funcs/steps_common";
import { gaterExSeqMode_getRampSpec } from "@core/motions/gaters/gater_ex_seq";
import { gaterMinLaxMode_getRampCodeCached } from "@core/motions/gaters/gater_main_lax";
import { gaterMainSeqMode_getRampCode } from "@core/motions/gaters/gater_main_seq";
