import { invPower2Weak, lowClipZero, mixValue } from "@core/ax/number_utils";
import { glideCurves } from "@core/ax-audio/basic/curves";
import { deterministicRandom } from "@core/ax-audio/basic/deterministic_random";
import {
  GateStride,
  MoRndMode,
  MoType,
  MotionParams,
  MotionStride,
} from "@core/base/parameter_defs";
import { SynthesisBus } from "@core/base/synthesis_bus";
import { RampSpec } from "@core/base/synthesis_types";
import * as eg_curves from "@core/motions/funcs/eg_curves";
import * as lfo_waves from "@core/motions/funcs/lfo_waves";
import * as steps_common from "@core/motions/funcs/steps_common";
import * as ramp_provider from "@core/motions/gaters/ramp_provider";
import { RandomValueMapperFn } from "@core/motions/impl/motion_common";
