...
} from "@core/synthesis_modules/delay";
import {
  createFilter,
  Filter,
  filter_processSamples,
  filter_reset,
} from "@core/synthesis_modules/filter";
import {
  createOscillators,
  Oscillators,
  oscillators_prepare,
  ...
  oscillators_reset,
} from "@core/synthesis_modules/oscillators";
import {
  createPhaser,
  Phaser,
  phaser_processSamples,
} from "@core/synthesis_modules/phaser";
import {
  createShaper,
  Shaper,
  shaper_prepare,
  shaper_processSamples,
} from "@core/synthesis_modules/shaper";
import {
  createStepDelay,
  StepDelay,
  stepDelay_prepare,
  stepDelay_processSamples,
} from "@core/synthesis_modules/step_delay";
import {
  createVoicingAmp,
  VoicingAmp,
  voicingAmp_processSamples,
  voicingAmp_reset,
} from "@core/synthesis_modules/voicing_amp";
