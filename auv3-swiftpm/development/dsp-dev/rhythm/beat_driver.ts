import {
  ...
  calcStepTimeSec,
} from "@core/ax-audio/basic/sequence_helper";
import { BassTailAccentPatternKey } from "@core/base/parameter_defs";
import { Bus } from "@core/base/synthesis_bus";
import { BassSynth, bassSynth_playTone } from "@core/rhythm/bass_synthesizer";
import {
  KickSynth,
  kickSynth_playTone,
  kickSynth_stopTone,
