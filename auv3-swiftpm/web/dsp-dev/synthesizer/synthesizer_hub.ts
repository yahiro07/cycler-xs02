...
import { power2 } from "@core/ax/number_utils";
import {
  applyBufferGain,
  applyBufferGainRms,
  applyBufferSoftClip,
  writeBuffer,
} from "@core/ax-audio/basic/buffer_functions";
import { mapDbGain } from "@core/ax-audio/basic/db_gain_mapper";
import { masterGainConfig } from "@core/ax-audio/basic/master_gain_config";
import { blWave2A_buildWaveTables } from "@core/ax-audio/oscillators/bl_wave_2a";
import { Bus, createSynthesisBus } from "@core/base/synthesis_bus";
import { getLoopBarsFromKey } from "@core/motions/funcs/steps_common";
import { gaterExSeqMode_setupLocalState } from "@core/motions/gaters/gater_ex_seq";
import { gaterMinLaxMode_setupLocalState } from "@core/motions/gaters/gater_main_lax";
import * as motions_root from "@core/motions/motions_root";
import {
  BassSynth,
  bassSynth_prepare,
  bassSynth_processSamples,
  createBassSynth,
} from "@core/rhythm/bass_synthesizer";
import {
  BeatDriver,
  beatDriver_advance,
  beatDriver_start,
  createBeatDriver,
} from "@core/rhythm/beat_driver";
import {
  createKickSynth,
  KickSynth,
  kickSynth_prepare,
  kickSynth_processSamples,
} from "@core/rhythm/kick_synthesizer";
import {
...
} from "@core/synthesizer/main_synthesis_line";
import {
